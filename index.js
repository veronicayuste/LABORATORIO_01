...
function compruebaClave1 () {
	...
	if (miClave1 == "") {
		...
		// Si la clave1 no está vacía, se comprueba si tiene al menos 8 caracteres. En el ejercicio se indica vía texto
		// que "el campo Clave deberá tener al menos 8 caracteres", y en la imagen siguiente aparece un mensaje en rojo 
		// indicando que "No debe tener más de 8 caracteres" Al ser esto incoherente, se implementa que tenga que tener
		// un mínimo de 8 caracteres, sin máximo.
		if (miClave1.length < 8) {
			// Si la clave1 tiene menos de 8 caracteres, se muestra el texto oculto y el borde/imagen rojo
			document.getElementById("errorClave1").style.display = "block";
			...
			// Si la clave1 tiene 8 o más caracteres (como se entiende por la explicación anterior),
